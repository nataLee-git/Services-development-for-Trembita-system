...
Публікація SOAP-сервісів в системі «Трембіта» здійснюється відповідно до настанов [Інструкції користувача шлюху безпечного обміну з роллю «Адміністратор вебсервісів»](https://portal.trembita.gov.ua/media/website-media/Instruktsiya_Administratora_vebservisiv.pdf). 
...
-	ідентифікатором методу вебсервісу, опублікованого на ШБО (значення даного параметру можна дізнатися безпосередньо у постачальника сервісу, знайти на **ШБО 2** самостійно або запитати у адміністратора даного ШБО);
